...
export function useTodo() {
    ...
    useEffect(() => {
        // Fetch a UserProfile
        // If there is a profile, then get user's TodoAccounts
    ...
    return { initialized, initializeUser, initializeStaticUser, loading, transactionPending, completedTodos, incompleteTodos, markStaticTodo, markTodo, removeStaticTodo, removeTodo, addTodo, addStaticTodo, input, setInput, handleChange }
}
